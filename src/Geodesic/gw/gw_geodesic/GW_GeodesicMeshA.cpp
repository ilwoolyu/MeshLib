...
GW_Bool GW_GeodesicMeshA::bUseUnfolding_ = GW_True;
 ...
 */
/*------------------------------------------------------------------------------*/
void GW_GeodesicMeshA::ResetGeodesicMesh()
{
 ...
 */
/*------------------------------------------------------------------------------*/
void GW_GeodesicMeshA::ResetParametrizationData()
{
	for( IT_VertexVector it=VertexVector_.begin(); it!=VertexVector_.end(); ++it )
	{
		GW_GeodesicVertex* pVert = (GW_GeodesicVertex*) *it;
 ...
 */
/*------------------------------------------------------------------------------*/
void GW_GeodesicMeshA::PerformFastMarching( GW_GeodesicVertex* pStartVertex )
{	
 ...
 */
/*------------------------------------------------------------------------------*/
void GW_GeodesicMeshA::SetUpFastMarching( GW_GeodesicVertex* pStartVertex )
{
 ...
 */
/*------------------------------------------------------------------------------*/
void GW_GeodesicMeshA::PerformFastMarchingFlush()
{
 ...
 */
/*------------------------------------------------------------------------------*/
GW_Bool GW_GeodesicMeshA::IsFastMarchingFinished()
{
...
*/
/*------------------------------------------------------------------------------*/
GW_Vertex* GW_GeodesicMeshA::GetRandomVertex(GW_Bool bForceFar)
{
	GW_U32 nNumber = 0;
